...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_file = get_variable("file",raw_locals,raw_globals);
        FILE* file = convert_to_file(py_file,"file");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_d133102ab45193e072f8dbb5a1f684850(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d133102ab45193e072f8dbb5a1f684850", compiled_methods);
}
