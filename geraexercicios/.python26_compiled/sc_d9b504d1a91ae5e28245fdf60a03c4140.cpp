...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    PyObject *py_func, *py_search_str, *py_sub_str;
    py_func = py_search_str = py_sub_str = NULL;
    ...
    {                                
        ...
        py_func = get_variable("func",raw_locals,raw_globals);
        py::object func = convert_to_catchall(py_func,"func");
        py_search_str = get_variable("search_str",raw_locals,raw_globals);
        std::string search_str = convert_to_string(py_search_str,"search_str");
        py_sub_str = get_variable("sub_str",raw_locals,raw_globals);
        std::string sub_str = convert_to_string(py_sub_str,"sub_str");
        /* inline code */                   
    ...
    /* cleanup code */                   
    Py_XDECREF(py_search_str);
    Py_XDECREF(py_sub_str);
...
PyMODINIT_FUNC initsc_d9b504d1a91ae5e28245fdf60a03c4140(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d9b504d1a91ae5e28245fdf60a03c4140", compiled_methods);
}
