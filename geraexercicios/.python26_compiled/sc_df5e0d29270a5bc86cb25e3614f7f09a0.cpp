...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_file_name = get_variable("file_name",raw_locals,raw_globals);
        std::string file_name = convert_to_string(py_file_name,"file_name");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_df5e0d29270a5bc86cb25e3614f7f09a0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_df5e0d29270a5bc86cb25e3614f7f09a0", compiled_methods);
}
