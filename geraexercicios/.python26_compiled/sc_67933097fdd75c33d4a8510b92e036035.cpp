...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_l = get_variable("l",raw_locals,raw_globals);
        py::list l = convert_to_list(py_l,"l");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_67933097fdd75c33d4a8510b92e036035(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_67933097fdd75c33d4a8510b92e036035", compiled_methods);
}
