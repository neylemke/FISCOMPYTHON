...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_t = get_variable("t",raw_locals,raw_globals);
        py::tuple t = convert_to_tuple(py_t,"t");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_67933097fdd75c33d4a8510b92e036033(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_67933097fdd75c33d4a8510b92e036033", compiled_methods);
}
