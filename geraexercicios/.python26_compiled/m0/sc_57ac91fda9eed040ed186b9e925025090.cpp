...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.len();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_57ac91fda9eed040ed186b9e925025090(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_57ac91fda9eed040ed186b9e925025090", compiled_methods);
}
