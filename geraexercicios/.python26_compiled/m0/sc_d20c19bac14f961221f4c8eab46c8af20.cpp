...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a["hello"] = 123.0;    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_d20c19bac14f961221f4c8eab46c8af20(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d20c19bac14f961221f4c8eab46c8af20", compiled_methods);
}
