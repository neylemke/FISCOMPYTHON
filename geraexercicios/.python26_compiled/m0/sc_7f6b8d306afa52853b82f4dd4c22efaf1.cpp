...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.count("alpha");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_7f6b8d306afa52853b82f4dd4c22efaf1(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_7f6b8d306afa52853b82f4dd4c22efaf1", compiled_methods);
}
