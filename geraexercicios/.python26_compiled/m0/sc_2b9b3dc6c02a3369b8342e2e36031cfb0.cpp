...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.insert(1,std::string("sissy"));    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_2b9b3dc6c02a3369b8342e2e36031cfb0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_2b9b3dc6c02a3369b8342e2e36031cfb0", compiled_methods);
}
