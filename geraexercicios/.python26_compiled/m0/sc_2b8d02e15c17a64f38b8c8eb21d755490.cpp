...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.attr("bar").call();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_2b8d02e15c17a64f38b8c8eb21d755490(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_2b8d02e15c17a64f38b8c8eb21d755490", compiled_methods);
}
