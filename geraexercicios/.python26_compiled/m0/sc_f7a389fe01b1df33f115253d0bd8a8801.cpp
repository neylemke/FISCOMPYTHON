...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.in("beta");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_f7a389fe01b1df33f115253d0bd8a8801(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_f7a389fe01b1df33f115253d0bd8a8801", compiled_methods);
}
