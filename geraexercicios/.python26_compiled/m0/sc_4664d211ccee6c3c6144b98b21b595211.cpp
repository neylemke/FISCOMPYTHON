...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.count(3.1416);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_4664d211ccee6c3c6144b98b21b595211(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_4664d211ccee6c3c6144b98b21b595211", compiled_methods);
}
