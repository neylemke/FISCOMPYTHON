...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.append(123.0);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_2609c2ccee3359bcdb8f58be698084080(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_2609c2ccee3359bcdb8f58be698084080", compiled_methods);
}
