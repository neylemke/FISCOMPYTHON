...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    PyObject *py_a, *py_key_name;
    py_a = py_key_name = NULL;
    ...
    {                                
        ...
        py_key_name = get_variable("key_name",raw_locals,raw_globals);
        std::string key_name = convert_to_string(py_key_name,"key_name");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_961d6594e4fc1b8e8e66737a6c78ae520(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_961d6594e4fc1b8e8e66737a6c78ae520", compiled_methods);
}
