...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        double key = convert_to_float(py_key,"key");
...
PyMODINIT_FUNC initsc_c74ad97099f7d86a4efefddc19b22a011(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_c74ad97099f7d86a4efefddc19b22a011", compiled_methods);
}
