...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.insert(1,1234);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_823c773b6d3c815362d29482da8527e10(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_823c773b6d3c815362d29482da8527e10", compiled_methods);
}
