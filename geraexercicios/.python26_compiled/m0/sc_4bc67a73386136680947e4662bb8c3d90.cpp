...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        std::string a = convert_to_string(py_a,"a");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val = (a == "hello");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_4bc67a73386136680947e4662bb8c3d90(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_4bc67a73386136680947e4662bb8c3d90", compiled_methods);
}
