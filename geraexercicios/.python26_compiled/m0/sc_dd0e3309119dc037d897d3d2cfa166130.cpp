...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = (a == (unsigned long)1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_dd0e3309119dc037d897d3d2cfa166130(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_dd0e3309119dc037d897d3d2cfa166130", compiled_methods);
}
