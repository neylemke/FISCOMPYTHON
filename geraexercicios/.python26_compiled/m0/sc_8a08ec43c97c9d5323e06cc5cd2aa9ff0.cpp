...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    PyObject *py_a, *py_attr_name;
    py_a = py_attr_name = NULL;
    ...
    {                                
        ...
        py_attr_name = get_variable("attr_name",raw_locals,raw_globals);
        std::string attr_name = convert_to_string(py_attr_name,"attr_name");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_8a08ec43c97c9d5323e06cc5cd2aa9ff0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_8a08ec43c97c9d5323e06cc5cd2aa9ff0", compiled_methods);
}
