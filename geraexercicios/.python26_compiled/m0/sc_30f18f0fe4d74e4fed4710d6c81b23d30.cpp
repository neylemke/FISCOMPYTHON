...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a[std::string("b")];    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_30f18f0fe4d74e4fed4710d6c81b23d30(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_30f18f0fe4d74e4fed4710d6c81b23d30", compiled_methods);
}
