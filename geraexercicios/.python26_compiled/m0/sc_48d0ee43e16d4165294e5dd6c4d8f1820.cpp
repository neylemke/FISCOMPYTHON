...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.attr(std::string("b"));    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_48d0ee43e16d4165294e5dd6c4d8f1820(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_48d0ee43e16d4165294e5dd6c4d8f1820", compiled_methods);
}
