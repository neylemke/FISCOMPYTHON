...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_b = get_variable("b",raw_locals,raw_globals);
        py::object b = convert_to_instance(py_b,"b");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val = (a == b);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_de61c48bb88e8c68ba6054f4ee8ef99d1(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_de61c48bb88e8c68ba6054f4ee8ef99d1", compiled_methods);
}
