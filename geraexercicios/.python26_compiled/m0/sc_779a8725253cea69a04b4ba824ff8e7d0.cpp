...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::dict b = convert_to_dict(py_b,"b");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        a.update(b);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_779a8725253cea69a04b4ba824ff8e7d0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_779a8725253cea69a04b4ba824ff8e7d0", compiled_methods);
}
