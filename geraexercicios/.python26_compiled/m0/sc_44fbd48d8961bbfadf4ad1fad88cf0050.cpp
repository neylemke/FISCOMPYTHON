...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.append(std::string("sissy"));    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_44fbd48d8961bbfadf4ad1fad88cf0050(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_44fbd48d8961bbfadf4ad1fad88cf0050", compiled_methods);
}
