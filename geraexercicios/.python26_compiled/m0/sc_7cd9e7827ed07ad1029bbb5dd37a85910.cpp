...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_Foo = get_variable("Foo",raw_locals,raw_globals);
        py::object Foo = convert_to_catchall(py_Foo,"Foo");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val = Foo.call();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_7cd9e7827ed07ad1029bbb5dd37a85910(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_7cd9e7827ed07ad1029bbb5dd37a85910", compiled_methods);
}
