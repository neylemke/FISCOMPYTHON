...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.attr("b");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_492866eb7b746d06b78af1c12c848c500(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_492866eb7b746d06b78af1c12c848c500", compiled_methods);
}
