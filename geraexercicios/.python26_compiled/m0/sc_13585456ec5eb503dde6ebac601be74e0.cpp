...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.insert(1,"bubba");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_13585456ec5eb503dde6ebac601be74e0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_13585456ec5eb503dde6ebac601be74e0", compiled_methods);
}
