...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        int key = convert_to_int(py_key,"key");
...
PyMODINIT_FUNC initsc_c74ad97099f7d86a4efefddc19b22a012(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_c74ad97099f7d86a4efefddc19b22a012", compiled_methods);
}
