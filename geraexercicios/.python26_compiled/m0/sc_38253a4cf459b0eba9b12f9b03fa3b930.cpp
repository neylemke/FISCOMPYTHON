...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.del("b");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_38253a4cf459b0eba9b12f9b03fa3b930(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_38253a4cf459b0eba9b12f9b03fa3b930", compiled_methods);
}
