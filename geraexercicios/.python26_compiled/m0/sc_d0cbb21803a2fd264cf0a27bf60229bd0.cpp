...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        std::complex<double> a = convert_to_complex(py_a,"a");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val=1.0/a;    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_d0cbb21803a2fd264cf0a27bf60229bd0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d0cbb21803a2fd264cf0a27bf60229bd0", compiled_methods);
}
