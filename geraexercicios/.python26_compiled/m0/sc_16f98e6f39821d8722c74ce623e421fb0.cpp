...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.set_attr("b",std::string("hello"));    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_16f98e6f39821d8722c74ce623e421fb0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_16f98e6f39821d8722c74ce623e421fb0", compiled_methods);
}
