...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = (a == 1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_1928489fb6e476d52eb79bc7c5da50f90(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_1928489fb6e476d52eb79bc7c5da50f90", compiled_methods);
}
