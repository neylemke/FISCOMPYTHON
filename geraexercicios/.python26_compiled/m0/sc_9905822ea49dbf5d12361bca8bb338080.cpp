...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.set_attr("b","hello");    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_9905822ea49dbf5d12361bca8bb338080(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_9905822ea49dbf5d12361bca8bb338080", compiled_methods);
}
