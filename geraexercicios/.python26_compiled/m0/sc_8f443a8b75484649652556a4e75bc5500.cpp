...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    PyObject *py_file_imposter;
    py_file_imposter = NULL;
    ...
    {                                
        ...
        py_file_imposter = get_variable("file_imposter",raw_locals,raw_globals);
        py::object file_imposter = convert_to_catchall(py_file_imposter,"file_imposter");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_8f443a8b75484649652556a4e75bc5500(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_8f443a8b75484649652556a4e75bc5500", compiled_methods);
}
