...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a[key] = "bubba";    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_293f5ff34c92d9dc8ff43d8d1e1774cf0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_293f5ff34c92d9dc8ff43d8d1e1774cf0", compiled_methods);
}
