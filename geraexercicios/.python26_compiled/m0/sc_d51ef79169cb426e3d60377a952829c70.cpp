...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.keys();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_d51ef79169cb426e3d60377a952829c70(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d51ef79169cb426e3d60377a952829c70", compiled_methods);
}
