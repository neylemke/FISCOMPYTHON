...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::list b = convert_to_list(py_b,"b");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_287d43e643a563b251d17a481a4a23c61(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_287d43e643a563b251d17a481a4a23c61", compiled_methods);
}
