...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.set_attr("b",1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_8bb3865f35498736e98ec18588022a320(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_8bb3865f35498736e98ec18588022a320", compiled_methods);
}
