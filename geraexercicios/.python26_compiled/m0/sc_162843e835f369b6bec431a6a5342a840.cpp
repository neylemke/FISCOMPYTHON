...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a[1] = "bubba";    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_162843e835f369b6bec431a6a5342a840(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_162843e835f369b6bec431a6a5342a840", compiled_methods);
}
