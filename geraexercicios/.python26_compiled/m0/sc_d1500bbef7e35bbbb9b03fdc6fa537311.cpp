...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.in(3.1416);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_d1500bbef7e35bbbb9b03fdc6fa537311(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d1500bbef7e35bbbb9b03fdc6fa537311", compiled_methods);
}
