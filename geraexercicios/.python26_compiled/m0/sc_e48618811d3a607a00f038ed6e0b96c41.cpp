...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.count(1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_e48618811d3a607a00f038ed6e0b96c41(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_e48618811d3a607a00f038ed6e0b96c41", compiled_methods);
}
