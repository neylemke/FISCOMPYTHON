...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::list a = convert_to_list(py_a,"a");
...
PyMODINIT_FUNC initsc_edee47bd05c2569658907980e11cffc90(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_edee47bd05c2569658907980e11cffc90", compiled_methods);
}
