...
PyMODINIT_FUNC initsc_bb7d265a6d2a50dcaa1173794350bc7f0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_bb7d265a6d2a50dcaa1173794350bc7f0", compiled_methods);
}
