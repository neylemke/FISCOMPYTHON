...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.set_attr("b",1.0);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_0cde7af9fd00fc4e7bd82941f066cd710(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_0cde7af9fd00fc4e7bd82941f066cd710", compiled_methods);
}
