...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.in(item);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_3214a110840bc292f6babc6b34e1db2a1(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_3214a110840bc292f6babc6b34e1db2a1", compiled_methods);
}
