...
static PyObject* test(PyObject*self, PyObject* args, PyObject* kywds)
{
    ...
    static char *kwlist[] = {"local_dict", NULL};
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"|O:test",kwlist,&py_local_dict))
       return NULL;
    try                              
    {                                
        /*<function call here>*/     
...
static PyObject* test2(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occured = 0;
    PyObject *py_local_dict = NULL;
    static char *kwlist[] = {"local_dict", NULL};
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"|O:test2",kwlist,&py_local_dict))
       return NULL;
    try                              
    {                                
        /*<function call here>*/     
...
static PyMethodDef compiled_methods[] = 
{
    ...
    {"test2",(PyCFunction)test2 , METH_VARARGS|METH_KEYWORDS},
    {NULL,      NULL}        /* Sentinel */
};

PyMODINIT_FUNC initmodule_multi_function(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("module_multi_function", compiled_methods);
}
