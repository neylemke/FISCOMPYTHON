...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a[key] = 123.0;    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_4c977fc5c69586c46f80b925bde266a90(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_4c977fc5c69586c46f80b925bde266a90", compiled_methods);
}
