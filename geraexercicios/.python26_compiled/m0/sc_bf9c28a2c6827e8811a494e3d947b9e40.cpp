...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.values();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_bf9c28a2c6827e8811a494e3d947b9e40(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_bf9c28a2c6827e8811a494e3d947b9e40", compiled_methods);
}
