...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.append(item);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_7350c348743e10db72c18be0f339a1bb0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_7350c348743e10db72c18be0f339a1bb0", compiled_methods);
}
