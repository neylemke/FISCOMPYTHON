...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.hash();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_c03278007f8e38ccea1e796dddc0f9930(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_c03278007f8e38ccea1e796dddc0f9930", compiled_methods);
}
