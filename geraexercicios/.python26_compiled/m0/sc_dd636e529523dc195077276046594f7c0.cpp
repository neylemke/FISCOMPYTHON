...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::object a = convert_to_catchall(py_a,"a");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        a[1] = std::complex<double>(1,1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_dd636e529523dc195077276046594f7c0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_dd636e529523dc195077276046594f7c0", compiled_methods);
}
