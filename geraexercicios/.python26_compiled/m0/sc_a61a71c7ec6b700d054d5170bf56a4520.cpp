...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.is_true();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_a61a71c7ec6b700d054d5170bf56a4520(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_a61a71c7ec6b700d054d5170bf56a4520", compiled_methods);
}
