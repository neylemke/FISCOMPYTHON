...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::tuple a = convert_to_tuple(py_a,"a");
        py_item = get_variable("item",raw_locals,raw_globals);
        int item = convert_to_int(py_item,"item");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val = a.count(item);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_edee47bd05c2569658907980e11cffc91(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_edee47bd05c2569658907980e11cffc91", compiled_methods);
}
