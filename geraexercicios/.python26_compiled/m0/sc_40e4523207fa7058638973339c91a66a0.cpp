...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::object a = convert_to_instance(py_a,"a");
        py_method = get_variable("method",raw_locals,raw_globals);
        std::string method = convert_to_string(py_method,"method");
        /* inline code */                   
        /* NDARRAY API VERSION 1000009 */
        return_val = a.mcall(method);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_40e4523207fa7058638973339c91a66a0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_40e4523207fa7058638973339c91a66a0", compiled_methods);
}
