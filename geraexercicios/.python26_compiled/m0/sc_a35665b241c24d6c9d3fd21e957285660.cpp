...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a["first"] = a["second"];    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_a35665b241c24d6c9d3fd21e957285660(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_a35665b241c24d6c9d3fd21e957285660", compiled_methods);
}
