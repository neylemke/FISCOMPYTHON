...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.unicode();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_bb62a8d47f95941a76cf6f58e4c52f6f0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_bb62a8d47f95941a76cf6f58e4c52f6f0", compiled_methods);
}
