...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.append(1234);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_fd68afa547f8ee906fc0b5bbdad0ad160(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_fd68afa547f8ee906fc0b5bbdad0ad160", compiled_methods);
}
