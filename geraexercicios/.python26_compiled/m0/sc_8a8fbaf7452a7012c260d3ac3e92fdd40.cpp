...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = (1 == a);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_8a8fbaf7452a7012c260d3ac3e92fdd40(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_8a8fbaf7452a7012c260d3ac3e92fdd40", compiled_methods);
}
