...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        a.append(1);    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_cebd6d03dc37c361f1f6ad006cd8cea30(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_cebd6d03dc37c361f1f6ad006cd8cea30", compiled_methods);
}
