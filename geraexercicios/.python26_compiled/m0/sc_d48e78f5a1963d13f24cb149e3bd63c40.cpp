...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.repr();    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_d48e78f5a1963d13f24cb149e3bd63c40(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_d48e78f5a1963d13f24cb149e3bd63c40", compiled_methods);
}
