...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        return_val = a.attr(std::string("c"));    /*I would like to fill in changed    locals and globals here...*/   
...
PyMODINIT_FUNC initsc_3909c060f05f65d0eb55988950c4f33d0(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_3909c060f05f65d0eb55988950c4f33d0", compiled_methods);
}
