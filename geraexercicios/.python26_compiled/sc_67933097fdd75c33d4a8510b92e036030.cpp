...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py::dict d = convert_to_dict(py_d,"d");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_67933097fdd75c33d4a8510b92e036030(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_67933097fdd75c33d4a8510b92e036030", compiled_methods);
}
