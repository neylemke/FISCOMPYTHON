...
static PyObject* compiled_func(PyObject*self, PyObject* args)
{
    ...
    {                                
        ...
        py_s = get_variable("s",raw_locals,raw_globals);
        std::string s = convert_to_string(py_s,"s");
        /* inline code */                   
...
PyMODINIT_FUNC initsc_67933097fdd75c33d4a8510b92e036036(void)
{
    
    Py_Initialize();
    import_array();
    PyImport_ImportModule("numpy");
    (void) Py_InitModule("sc_67933097fdd75c33d4a8510b92e036036", compiled_methods);
}
